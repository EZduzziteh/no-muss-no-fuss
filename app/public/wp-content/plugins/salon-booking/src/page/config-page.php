...
?>
	...
	<script type="text/javascript" charset="utf-8">
		...
		$j(document).ready(function() {
			...
			$j("#config_is_user_login").prop("checked",<?php echo $set_boolean; ?>);

			<?php if ( $this->config_datas['SALON_CONFIG_DELETE_RECORD'] == Salon_Config::DELETE_RECORD_YES ) $set_boolean = 'true';
					else $set_boolean = 'false'; ?>
			$j("#config_is_delete_record").prop("checked",<?php echo $set_boolean; ?>);
			...
			$j("#config_is_log_need").prop("checked",<?php echo $set_boolean; ?>);
			<?php if ( $this->config_datas['SALON_CONFIG_SHOW_DETAIL_MSG'] == Salon_Config::DETAIL_MSG_OK ) $set_boolean = 'true';
					else $set_boolean = 'false'; ?>
			$j("#config_is_show_detail_msg").prop("checked",<?php echo $set_boolean; ?>);
			...
			$j("#config_is_no_preference").prop("checked",<?php echo $set_boolean; ?>);
			...
			$j("#config_maintenance_include_staff").prop("checked",<?php echo $set_boolean; ?>);

			<?php if ( $this->config_datas['SALON_CONFIG_MOBILE_USE'] == Salon_Config::MOBILE_USE_YES ) $set_boolean = 'true';
					else $set_boolean = 'false'; ?>
			$j("#config_mobile_use").prop("checked",<?php echo $set_boolean; ?>);
