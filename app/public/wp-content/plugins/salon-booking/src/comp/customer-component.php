...
class Customer_Component {
	...
	public function edit_page_data() {
		$page_data['displayStart'] = intval(@$_REQUEST['iDisplayStart']);
		$page_data['displayLength'] = intval(@$_REQUEST['iDisplayLength']);
		$page_data['filter'] = stripslashes(@$_POST['sSearch']);
		return $page_data;
	}
